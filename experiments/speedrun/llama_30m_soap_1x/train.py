...
"""
Phase 1: 30M Llama with SOAP optimizer at 1× Chinchilla-optimal data.

Tests SOAP optimizer effectiveness on smaller models.
...
speedrun_config = SpeedrunConfig(
    ...
    description="Phase 1: 30M Llama with SOAP optimizer at 1× Chinchilla (600M tokens). Tests SOAP on smaller models.",
...
if __name__ == "__main__":
    executor_main(steps=default_speedrun("llama_30m_soap_1x", speedrun_config))
