...
"""
Phase 1: 30M Llama with Muon optimizer at 1× Chinchilla-optimal data.

Baseline validation: Does Muon beat Adam at standard scale for 30M?
...
speedrun_config = SpeedrunConfig(
    ...
    description="Phase 1: 30M Llama with Muon at 1× Chinchilla (600M tokens). Baseline validation.",
...
if __name__ == "__main__":
    executor_main(steps=default_speedrun("llama_30m_muon_1x", speedrun_config))
