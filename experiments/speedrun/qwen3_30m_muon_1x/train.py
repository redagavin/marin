...
"""
Phase 1: 30M Qwen3 with Muon optimizer at 1× Chinchilla-optimal data.

Tests Qwen3 architecture which features QK normalization for improved stability.
Expected: 1.46-1.50 BPB (better than Llama due to QK norm)
"""
...
speedrun_config = SpeedrunConfig(
    ...
    description="Phase 1: 30M Qwen3 with Muon at 1× Chinchilla (600M tokens). Tests QK normalization benefits.",
...
if __name__ == "__main__":
    executor_main(steps=default_speedrun("qwen3_30m_muon_1x", speedrun_config))
